...
//       <SidebarContent className='max-w-56'>
//         <SidebarGroup>
...
//                 <SidebarMenuItem
//                   key={item.title}
//                   className='mx-auto flex w-full max-w-56 justify-center'
//                 >
  ...
  return (
    ...
    >
      <SidebarHeader className='pt-16'>
        {' '}
        {/* Add top padding for main header */}
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton
              asChild
      ...
      <SidebarRail /> {/* Re-enable the rail for better UX */}
    </Sidebar>
  );
}
