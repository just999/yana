    ...
    <>
      {blogs?.map((post) => {
        ...
        return (
          ...
          //       <Badge
          //         variant='secondary'
          //         className='bg-stone-500/50 font-normal'
          //       >
          //         {post.category}
          //       </Badge>
          //       <div className='flex items-center gap-1 text-xs'>
          //         <span className='align-middle text-xs text-sky-500'>
          //           187{' '}
          //         </span>{' '}
          //         views
          //       </div>
          ...
          //         <span className='text-amber-300'>3 mins</span>
          //       </span>
          //     </div>
          ...
          <BlogCard post={post} type={type} key={post.id} />
        );
      })}
    </>
  );
