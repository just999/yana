...
// import { TokenType, User } from '@/lib/generated/prisma/client';
// import { UserProps } from '@/lib/jotai/user-atoms';
// import { sendTwoFactorTokenEmail } from '@/lib/mails/email-two-factor';
...
// import { undefined, z, ZodIssue } from 'zod';
...
//         if (twoFactorToken.data?.token !== code) {
//           return {
//             error: true,
//             message: 'Invalid code!',
//           };
...
//         const hasExpired = new Date(twoFactorToken.data.expires) < new Date();
...
//           where: { id: twoFactorToken.data.id },
//         });
...
//         error: true,
//         message:
//           'password not the same, please fucking input the same password, u mother fucker...',
//       };
//     }
