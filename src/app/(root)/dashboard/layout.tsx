  ...
  return (
    ...
    >
      ...
      <div className='w-full pt-[64px]'>
        <SidebarInset className='rounded-xl'>
          <header className='sticky top-14 z-50 flex h-(--header-height) w-full shrink-0 items-center gap-2 rounded-t-xl border-b backdrop-blur-sm transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-(--header-height) dark:bg-gray-900/70'>
            <div className='flex w-full items-center gap-1 px-4 lg:gap-2 lg:px-6'>
              <SidebarTrigger className='-ml-1' />
              <Separator
                orientation='vertical'
          ...
          <main className='mx-auto w-full p-0 xl:max-w-6xl'>
            <div className='min-h-screen min-w-[420px] px-0 sm:px-0 lg:min-w-6xl lg:px-8'>
              {children}
            </div>
          </main>
        </SidebarInset>
